...
_Static_assert(sizeof(struct loom_coro_ctx) == 96, "ctx layout drift: sizeof (see ctx_x86_64.S)");
...
_Static_assert(offsetof(struct loom_coro_ctx, pc) == 0, "ctx layout drift: pc (see ctx_aarch64.S)");
_Static_assert(offsetof(struct loom_coro_ctx, sp) == 8, "ctx layout drift: sp (see ctx_aarch64.S)");
...
_Static_assert(sizeof(struct loom_coro_ctx) == 144, "ctx layout drift: sizeof (see ctx_aarch64.S)");
